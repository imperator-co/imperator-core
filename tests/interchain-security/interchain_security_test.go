...
import (
	...
	appConsumer "github.com/imperator-co/imperator-core/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and s16 consumer chain
